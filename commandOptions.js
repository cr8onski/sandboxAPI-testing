...
/*
This is the Login function which can be used by all endpoint testing programs.
Question is how do I want to do this? do I accept uid and pword and the
callback and test and use a defalut if not provided? Thst does seem the best
way.  I'm unsure I can do it, but let's go for it.
*/
module.exports.login = function (uid, pword, cb) {
    ...
    var reqSalt = function () {
    	...
    	request(module.exports.salt, reqLogin);
    }
